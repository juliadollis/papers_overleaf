...
Estrutura do artigo
Artigos nas categorias (a) e (b) devem ter a seguinte estrutura: Introdução, Metodologia
da pesquisa (Questões de pesquisa, Palavras-chave e sinônimos, Bases de busca,
Critérios de inclusão e exclusão, Questões de qualidade, Execução da revisão),
Métodos identificados, Conclusões e Referências.
